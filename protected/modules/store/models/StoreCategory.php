...
class StoreCategory extends \yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            [
                'name, title, description, short_description, slug, meta_title, meta_keywords, meta_description, name_short, subtitle',
                'filter',
                'filter' => 'trim',
            ],
            ...
            ['name, title, image, image_alt, image_title, meta_title, meta_keywords, meta_description, meta_canonical, name_short, icon', 'length', 'max' => 250],
            ['slug', 'length', 'max' => 150],
            ...
            ['meta_canonical', 'url'],
            ['id, parent_id, name, description, sort, short_description, slug, status, name_short, subtitle', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        return [
            ...
            'children' => [self::HAS_MANY, 'StoreCategory', 'parent_id', 'scopes' => ['published']],
            'productCount' => [self::STAT, 'Product', 'category_id'],
            'photos' => [self::HAS_MANY, 'CategoryImage', 'category_id'],
            'images' => [self::HAS_MANY, 'CategoryImage', 'category_id'],
            'icon' => [self::HAS_MANY, 'CategoryImage', 'category_id'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'subtitle' => Yii::t('StoreModule.store', 'Subtitle'),
            'icon' => Yii::t('StoreModule.store', 'Additional image'),
        ];
    }
