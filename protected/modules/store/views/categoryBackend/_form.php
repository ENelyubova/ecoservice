...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        ...
        <div class='row'>
            <div class="col-sm-7">
                <div class="preview-image-wrapper<?= !$model->isNewRecord && $model->image ? '' : ' hidden' ?>">
                    ...
                    <?php
                    echo CHtml::image(
                        !$model->isNewRecord && $model->image ? $model->getImageNewUrl(200, 200, true, null, 'image') : '#',
                        $model->name,
                        [
        ...
        <div class='row'>
            <div class="col-sm-7">
                <div class="preview-image-wrapper<?= !$model->isNewRecord && $model->image ? '' : ' hidden' ?>">
                    ...
                    <?php
                    echo CHtml::image(
                        !$model->isNewRecord && $model->icon ? $model->getImageNewUrl(200, 200, true, null, 'icon') : '#',
                        $model->name,
                        [
                            'class' => 'preview-image img-thumbnail',
        ...
        <div class='row'>
            <div class="col-sm-12 <?= $model->hasErrors('subtitle') ? 'has-error' : ''; ?>">
