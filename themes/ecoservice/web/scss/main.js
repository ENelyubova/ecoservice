...
/**
   ...
   */
    ...
    */
    ...
    /*
     * Кнопка показать все подкатегории
    */
    $(document).delegate('.js-subcategory-more', 'click', function(){
        var span = $(this).find('span');
        var text = $(this).data('text');

        if($(this).hasClass('active')){
            $(this).removeClass('active');
            $('.js-subcategory').removeClass('active').find('.js-subcategory-item.hidden2').addClass('hidden').removeClass('hidden2');
            $(this).data('text', span.text());
            span.text(text);
        } else {
            $(this).addClass('active');
            $('.js-subcategory').addClass('active').find('.js-subcategory-item.hidden').addClass('hidden2').removeClass('hidden');
            $(this).data('text', span.text());
            span.text(text);
        }
        return false;
    ...
    /*404*/
    function pageErrorHeaderClass() {
        $(".page-404").each(function() {
            var header = $(this).find('header').removeClass('header-page');
            header.addClass('header-home');
        });
    }
    pageErrorHeaderClass();
    ...
    if($('div').hasClass('carouselSlider')){
        ...
        mainSlide.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            $('.counter').html((+i) + '<span>/ ' + (slick.slideCount)+ '</span>');
        });
    ...
    if($('div').hasClass('aboutSlider')){
        $('.aboutSlider').slick({
            ...
            focusOnSelect: false,
            draggable: false,
            asNavFor: $('.about-thumb-carousel1, .about-thumb-carousel2'),
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            responsive: [
                {
    ...
    /*Миниатюры галерея*/
    if($('div').hasClass('about-thumb-carousel1')){
        $('.about-thumb-carousel1').slick({
            fade: false,
            infinite: true,
            slidesToShow: 1,
            slidesToScroll: 1,
            ...
            arrows: false,
            dots: false,
            asNavFor: $('.aboutSlider, .about-thumb-carousel2'),
            focusOnSelect: false,
            draggable: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
    ...
    /*Миниатюры галерея*/
    if($('div').hasClass('about-thumb-carousel2')){
        $('.about-thumb-carousel2').slick({
            fade: false,
            infinite: true,
            slidesToShow: 1,
            slidesToScroll: 1,
            ...
            arrows: false,
            dots: false,
            asNavFor: $('.aboutSlider, .about-thumb-carousel1'),
            focusOnSelect: false,
            draggable: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
    ...
    /*Партнеры*/
    if($('div').hasClass('partners-slider')){
        $('.partners-slider').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.partners-nav .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
    ...
    /*Категории*/
    if($('div').hasClass('catalog-slider')){
    ...
    if($('div').hasClass('category-slider')){
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                arrows: true,
                asNavFor: null,
                prevArrow: '<button class="slick-prev" aria-label="Previous" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="22" viewBox="0 0 14 22" fill="none"><path d="M12 20L3 11L12 2" stroke="black" stroke-width="3"/></svg></button>',
                nextArrow: '<button class="slick-next" aria-label="Next" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="22" viewBox="0 0 14 22" fill="none"><path d="M2 2L11 11L2 20" stroke="black" stroke-width="3"/></svg></button>',
                autoplay: false,
                autoplaySpeed: 3000,
                centerMode: false,
                centerPadding: '50px',
